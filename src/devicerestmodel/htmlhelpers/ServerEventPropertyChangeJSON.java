 ...
 * @author root
 */
public class ServerEventPropertyChangeJSON extends EventOutput implements PropertyChangeListener {
    
    private final PropertyChangeSupport mySupport;
    
    public ServerEventPropertyChangeJSON(PropertyChangeSupport support) {
        mySupport = support;
